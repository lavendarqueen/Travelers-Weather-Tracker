...
if (localStorage.getItem("cities") === typeof Array) {
  // Use JSON.parse to convert the data from the cities array into a JavaScript object
  const localArr = JSON.parse(localStorage.getItem("cities"));
  // Use JSON.push to add the retrieved data into the end of the array localArr
...
function handleSearch(event) {
  ...
  // Weather api searches and fetches:
